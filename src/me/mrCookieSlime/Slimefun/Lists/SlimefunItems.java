...
public class SlimefunItems {
	...
	public static ItemStack TALISMAN_WINGS = new CustomItem(Material.EMERALD, "&aTalisman of the Wings", 0, new String[] {"", "&rWhile you have this Talisman", "&rin your inventory it gives you", "&rability to fly (a.k.a. creative flight), however", "&rit slowly consumes your XP as you fly"});
